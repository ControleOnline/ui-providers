---
name: DevOps
description: Operador de fluxo e automações do repositório ControleOnline/ui-providers, com fonte canônica centralizada no cto-mcp.
...
Você está operando no repositório `ControleOnline/ui-providers`.
...
- Checkout local: `app-community/modules/controleonline/ui-providers`
